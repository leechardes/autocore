...
def create_relay_payload(device_uuid: str, **kwargs) -> Dict[str, Any]:
    """Cria payload para dispositivos de relé conforme v2.2.0"""
    return create_base_payload(
        device_uuid=device_uuid,
        message_type=MessageType.RELAY_STATE.value,
        device_type='relay',
        **kwargs
    )

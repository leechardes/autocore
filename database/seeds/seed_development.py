...
def seed_devices(session):
    ...
    devices = [
        ...
        Device(
            ...
            type=DeviceType.ESP32_RELAY,  # Mapear esp32_controls para ESP32_RELAY
        ...
        Device(
            ...
            uuid='esp32-can-001',
            name='Interface CAN',
            type=DeviceType.ESP32_RELAY,  # Mapear esp32_can para ESP32_RELAY
        ...
        Device(
            ...
            type=DeviceType.ESP32_RELAY,  # Mapear gateway para ESP32_RELAY
...
def seed_relay_channels(session):
    ...
    channels = [
        ...
        RelayChannel(id=1, board_id=1, channel_number=1, name='Farol Alto', description='Farol alto principal', 
                    function_type=FunctionType.MOMENTARY, icon='light-high', color='#FF6B35', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=False),
        RelayChannel(id=2, board_id=1, channel_number=2, name='Farol Baixo', description='Farol baixo principal',
                    function_type=FunctionType.PULSE, icon='light-low', color='#FFFFAA', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        RelayChannel(id=3, board_id=1, channel_number=3, name='Milha', description='Farol de milha',
                    function_type=FunctionType.TOGGLE, icon='light-fog', color='#FFFF88', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        RelayChannel(id=4, board_id=1, channel_number=4, name='Strobo', description='Luzes de emergência',
                    function_type=FunctionType.MOMENTARY, icon='light-emergency', color='#FF0000', 
                    protection_mode=ProtectionMode.CONFIRM, max_activation_time=300, is_active=True, allow_in_macro=False),
        RelayChannel(id=5, board_id=1, channel_number=5, name='Guincho', description='Guincho elétrico',
                    function_type=FunctionType.PULSE, icon='winch', color='#FFA500', 
                    protection_mode=ProtectionMode.PASSWORD, max_activation_time=60, is_active=True, allow_in_macro=False),
        RelayChannel(id=6, board_id=1, channel_number=6, name='Compressor', description='Compressor de ar',
                    function_type=FunctionType.TOGGLE, icon='air-compressor', color='#00AAFF', 
                    protection_mode=ProtectionMode.CONFIRM, max_activation_time=600, is_active=True, allow_in_macro=True),
        RelayChannel(id=7, board_id=1, channel_number=7, name='Inversor', description='Inversor 110V/220V',
                    function_type=FunctionType.MOMENTARY, icon='power-inverter', color='#00FF00', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=False),
        RelayChannel(id=8, board_id=1, channel_number=8, name='Rádio VHF', description='Rádio comunicação',
                    function_type=FunctionType.PULSE, icon='radio', color='#8888FF', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        RelayChannel(id=9, board_id=1, channel_number=9, name='Bomba Combustível', description='Bomba de combustível auxiliar',
                    function_type=FunctionType.TOGGLE, icon='fuel-pump', color='#AA5500', 
                    protection_mode=ProtectionMode.PASSWORD, is_active=True, allow_in_macro=True),
        RelayChannel(id=10, board_id=1, channel_number=10, name='Ventoinha Extra', description='Ventoinha adicional radiador',
                    function_type=FunctionType.MOMENTARY, icon='fan', color='#00FFFF', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=False),
        RelayChannel(id=11, board_id=1, channel_number=11, name='Trava Diferencial', description='Bloqueio do diferencial',
                    function_type=FunctionType.PULSE, icon='diff-lock', color='#FF8800', 
                    protection_mode=ProtectionMode.CONFIRM, is_active=True, allow_in_macro=True),
        RelayChannel(id=12, board_id=1, channel_number=12, name='Câmera Ré', description='Sistema de câmera de ré',
                    function_type=FunctionType.TOGGLE, icon='camera', color='#AA00FF', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        RelayChannel(id=13, board_id=1, channel_number=13, name='Aux 1', description='Auxiliar 1',
                    function_type=FunctionType.MOMENTARY, icon='aux', color='#888888', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=False),
        RelayChannel(id=14, board_id=1, channel_number=14, name='Aux 2', description='Auxiliar 2',
                    function_type=FunctionType.PULSE, icon='aux', color='#888888', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        RelayChannel(id=15, board_id=1, channel_number=15, name='Aux 3', description='Auxiliar 3',
                    function_type=FunctionType.TOGGLE, icon='aux', color='#888888', 
                    protection_mode=ProtectionMode.NONE, is_active=True, allow_in_macro=True),
        ...
        RelayChannel(id=17, board_id=2, channel_number=1, name='Canal 1', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=18, board_id=2, channel_number=2, name='Canal 2', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=19, board_id=2, channel_number=3, name='Canal 3', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=20, board_id=2, channel_number=4, name='Canal 4', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=21, board_id=2, channel_number=5, name='Canal 5', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=22, board_id=2, channel_number=6, name='Canal 6', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=23, board_id=2, channel_number=7, name='Canal 7', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=24, board_id=2, channel_number=8, name='Canal 8', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=25, board_id=2, channel_number=9, name='Canal 9', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=26, board_id=2, channel_number=10, name='Canal 10', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=27, board_id=2, channel_number=11, name='Canal 11', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=28, board_id=2, channel_number=12, name='Canal 12', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=29, board_id=2, channel_number=13, name='Canal 13', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=30, board_id=2, channel_number=14, name='Canal 14', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=31, board_id=2, channel_number=15, name='Canal 15', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True),
        RelayChannel(id=32, board_id=2, channel_number=16, name='Canal 16', function_type=FunctionType.TOGGLE,
                    icon='aux', color='#888888', protection_mode=ProtectionMode.NONE, is_active=False, allow_in_macro=True)
    ]
...
def seed_screen_items(session):
    ...
    items = [
        # Dashboard Home
        ScreenItem(
            id=1, screen_id=1, item_type=ItemType.DISPLAY, name='speed', label='Velocidade',
        ...
        ScreenItem(
            id=2, screen_id=1, item_type=ItemType.DISPLAY, name='rpm', label='RPM',
        ...
        ScreenItem(
            id=3, screen_id=1, item_type=ItemType.DISPLAY, name='temp', label='Temperatura',
        ...
        ScreenItem(
            id=4, screen_id=1, item_type=ItemType.DISPLAY, name='fuel', label='Combustível',
        ...
        # Tela Iluminação
        ScreenItem(
            id=5, screen_id=2, item_type=ItemType.BUTTON, name='btn_farol_alto', label='Farol Alto',
            icon='light-high', position=1, size_mobile='large', size_display_small='normal',
            size_display_large='normal', size_web='normal', action_type=ActionType.RELAY_CONTROL,
            action_payload='{}', is_active=True, relay_board_id=1, relay_channel_id=1
        ),
        ScreenItem(
            id=6, screen_id=2, item_type=ItemType.BUTTON, name='btn_farol_baixo', label='Farol Baixo',
        ...
        ScreenItem(
            id=7, screen_id=2, item_type=ItemType.BUTTON, name='btn_milha', label='Milha',
        ...
        ScreenItem(
            id=8, screen_id=2, item_type=ItemType.SWITCH, name='btn_strobo', label='Strobo',
        ...
        # Tela Acessórios
        ScreenItem(
            id=9, screen_id=3, item_type=ItemType.BUTTON, name='btn_guincho', label='Guincho',
        ...
        ScreenItem(
            id=10, screen_id=3, item_type=ItemType.BUTTON, name='btn_compressor', label='Compressor',
        ...
        ScreenItem(
            id=11, screen_id=3, item_type=ItemType.BUTTON, name='btn_inversor', label='Inversor 110V',
        ...
        ScreenItem(
            id=12, screen_id=3, item_type=ItemType.BUTTON, name='btn_radio', label='Rádio VHF',
        ...
        # Botões extras
        ScreenItem(
            id=13, screen_id=2, item_type=ItemType.BUTTON, name='test_new_relay', label='Teste Novo Relé',
        ...
        ScreenItem(
            id=14, screen_id=3, item_type=ItemType.BUTTON, name='bt_aux', label='Auxiliar',

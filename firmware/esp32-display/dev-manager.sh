...
# AutoCore ESP32 Display - Development Manager
# Ferramenta completa de desenvolvimento e debug

PROJETO_DIR="/Users/leechardes/Projetos/AutoCore/firmware/esp32-display"
...
show_header() {
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║                    ${WHITE}🚗 AutoCore ESP32 Display${CYAN}                      ║${NC}"
